...
const KEY_FEATURES = [
  ...
  "39 melodic instruments and 19 sound packs, including twelve local CC0 sampled instruments",
  "Custom instruments from your own recordings, mapped across keyboard octaves",
